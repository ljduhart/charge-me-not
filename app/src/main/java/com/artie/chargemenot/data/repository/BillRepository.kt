...
class BillRepository(
    ...
    fun getBillsByParentCategory(parentCategory: String): Flow<List<Bill>> =
        billDao.getBillsByParentCategory(parentCategory).map { entities -> entities.map { it.toDomain() } }
